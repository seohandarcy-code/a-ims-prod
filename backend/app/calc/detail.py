...
DETAIL_COLUMNS: list[dict] = [
    ...
    {"key": "erp_registered", "label": "ERP등록(CPMS포함)", "type": "text"},
    {"key": "it_pms", "label": "IT-PMS", "type": "text"},
    {"key": "contract_complete_flag", "label": "계약완료", "type": "text"},
    ...
    {"key": "executed_amount", "label": "집행금액(실행품의금액)", "type": "money"},
        ...
        rows.append(
            {
                ...
                "erp_registered": row[COL["erp_registered"]],
                "irb_review": row[COL["irb_review"]],
                "it_pms": row[COL["it_pms"]],
                "contract_complete_flag": row[COL["contract_complete_flag"]],
                ...
                "investment_complete": row[COL["investment_complete"]],
            }
        )
